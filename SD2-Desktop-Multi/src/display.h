...
public:
  ...
  void Web_win();                 //Web配网界面
  void app1(unsigned char Get_Hour,unsigned char Get_Minute,unsigned char Get_Second,unsigned char Get_Month,unsigned char Get_Day,unsigned char Get_Week);
  void app2(int xms);
};
