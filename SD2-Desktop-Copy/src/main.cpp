 ...
 *  字库、图片库
 * *****************************************************************/
#include "font/ZoloFont_20.h"  //字体库
...
void Webconfig() {
  ...
  //  Field Placeholder\" type=\"checkbox\""); // custom html type

  // test custom html(radio)
  // const char* custom_radio_str = "<br/><label for='customfieldid'>Custom
  // Field Label</label><input type='radio' name='customfieldid' value='1'
  // checked> One<br><input type='radio' name='customfieldid' value='2'>
  // Two<br><input type='radio' name='customfieldid' value='3'> Three"; new
  // (&custom_field) WiFiManagerParameter(custom_radio_str); // custom html
  // input
...
void setup() {
  ...
  reflash_openWifi.setInterval(updateweater_time * 60 *
                               TMS); // 设置所需间隔 10分钟
...
#if Animate_Choice
  if (millis() - Amimate_reflash_Time > 100) {
