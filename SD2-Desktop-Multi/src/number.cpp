...
// 显示白色80*120大小数字
void Number::printfB80120(int numx, int numy, int numn) {
  switch (numn) {
  case 0:
    TJpgDec.drawJpg(numx, numy, B_80120_i0, sizeof(B_80120_i0));
    break;
  case 1:
    TJpgDec.drawJpg(numx, numy, B_80120_i1, sizeof(B_80120_i1));
    break;
  case 2:
    TJpgDec.drawJpg(numx, numy, B_80120_i2, sizeof(B_80120_i2));
    break;
  case 3:
    TJpgDec.drawJpg(numx, numy, B_80120_i3, sizeof(B_80120_i3));
    break;
  case 4:
    TJpgDec.drawJpg(numx, numy, B_80120_i4, sizeof(B_80120_i4));
    break;
  case 5:
    TJpgDec.drawJpg(numx, numy, B_80120_i5, sizeof(B_80120_i5));
    break;
  case 6:
    TJpgDec.drawJpg(numx, numy, B_80120_i6, sizeof(B_80120_i6));
    break;
  case 7:
    TJpgDec.drawJpg(numx, numy, B_80120_i7, sizeof(B_80120_i7));
    break;
  case 8:
    TJpgDec.drawJpg(numx, numy, B_80120_i8, sizeof(B_80120_i8));
    break;
  case 9:
    TJpgDec.drawJpg(numx, numy, B_80120_i9, sizeof(B_80120_i9));
    break;
  default:
    Serial.println("显示B_80120数字错误");
    break;
  }
}
// 显示橙色80*120大小数字
void Number::printfO80120(int numx, int numy, int numn) {
  switch (numn) {
  case 0:
    TJpgDec.drawJpg(numx, numy, O_80120_i0, sizeof(O_80120_i0));
    break;
  case 1:
    TJpgDec.drawJpg(numx, numy, O_80120_i1, sizeof(O_80120_i1));
    break;
  case 2:
    TJpgDec.drawJpg(numx, numy, O_80120_i2, sizeof(O_80120_i2));
    break;
  case 3:
    TJpgDec.drawJpg(numx, numy, O_80120_i3, sizeof(O_80120_i3));
    break;
  case 4:
    TJpgDec.drawJpg(numx, numy, O_80120_i4, sizeof(O_80120_i4));
    break;
  case 5:
    TJpgDec.drawJpg(numx, numy, O_80120_i5, sizeof(O_80120_i5));
    break;
  case 6:
    TJpgDec.drawJpg(numx, numy, O_80120_i6, sizeof(O_80120_i6));
    break;
  case 7:
    TJpgDec.drawJpg(numx, numy, O_80120_i7, sizeof(O_80120_i7));
    break;
  case 8:
    TJpgDec.drawJpg(numx, numy, O_80120_i8, sizeof(O_80120_i8));
    break;
  case 9:
    TJpgDec.drawJpg(numx, numy, O_80120_i9, sizeof(O_80120_i9));
    break;
  default:
    Serial.println("显示O_80120数字错误");
    break;
  }
}
